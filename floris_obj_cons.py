...
class Floris:
    ...
    def evaluate_distance_from_boundries_constr(self, x:list):
        ...
        # normalizing it with the width of the domain, also added negative sign constraint negative hwen its satisfied and positive when not satisfied
    ...
    def get_AEP(self,x):
        ...
        self.fi.reinitialize(layout_x=locs_unnorm[0:self.lo.nturbs], layout_y=locs_unnorm[self.lo.nturbs :2 * self.lo.nturbs])
